...
#SBATCH -J ${runtag}_${jobtag} -t 80:0
...
ml purge
#ml openmpi/5.0.1
source /pkg/x86/apps/oneapi/setvars.sh
...
#test_weak   weak5   5 18 18
#test_strong strong5 5 18 18
test_one one7 1 1 1   7   18 18

#test_weak   pweak4 4 18 18
#test_weak   pweak5 5 18 18
#test_weak   pweak6 6 18 18
